...
def main(argv):
  ...
  for i in range(0,10):
    ...
    counter = 0
    os.mkdir(f"/home/pawblo/Desktop/mgr/mnk/mcts_start__5_5_4{i}/")
    for move in q:
      
      output_file_path = f"/home/pawblo/Desktop/mgr/mnk/mcts_start__5_5_4{i}/" + f"output_{move.replace(" ", "")}.txt"
      counter += 1
      f = io.StringIO()
